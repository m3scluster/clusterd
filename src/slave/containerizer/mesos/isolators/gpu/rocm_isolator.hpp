...
#ifndef __ROCM_GPU_ISOLATOR_HPP__
#define __ROCM_GPU_ISOLATOR_HPP__
...
// access to Rocm GPUs. Since this is the very first device
...
// that the necessary Rocm libraries are visible in the
...
class RocmGpuIsolatorProcess : public MesosIsolatorProcess
{
public:
...
#endif // __ROCM_GPU_ISOLATOR_HPP__
