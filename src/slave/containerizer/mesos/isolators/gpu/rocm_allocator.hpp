...
#ifndef __ROCM_GPU_ALLOCATOR_HPP__
#define __ROCM_GPU_ALLOCATOR_HPP__
...
class RocmGpuAllocator
{
public:
  RocmGpuAllocator() = delete;

  static Try<Resources> resources(const Flags& flags);

  static Try<RocmGpuAllocator> create(
      const Flags& flags,
...
private:
  RocmGpuAllocator(const std::set<Gpu>& gpus);
...
#endif // __ROCM_GPU_ALLOCATOR_HPP__
